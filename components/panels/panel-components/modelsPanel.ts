...
export const createModelsPanel = (
  ...
  return BUI.html`
    <div class="models-panel rounded-b-lg overflow-hidden mb-0 border border-gray-200">
      <!-- Collapsible Header -->
      <div @click=${toggleModelsPanel} class="flex items-center p-3 bg-white border-b border-gray-200 cursor-pointer select-none transition-colors duration-200 ease-in-out hover:bg-gray-50">
