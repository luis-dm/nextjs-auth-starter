...
export const skill = {
  ...
  description:
    "Generate a comprehensive summary of BIM elements including counts, categories, storeys, and key statistics",
  parameters: {
    type: "object",
    properties: {
      category: {
      ...
      pattern: {
        type: "string",
        description:
          "Optional: limit description to elements matching name pattern",
      },
    },
  },
