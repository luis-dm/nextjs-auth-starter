export const skill = {
  ...
  description: "Isolate BIM elements in the 3D viewer (hide everything except the specified elements). Use this to focus on specific elements.",
  parameters: {
    type: "object",
    properties: {
      elementIds: {
        type: "array",
        items: { type: "number" },
        description: "Array of element IDs to isolate (localIds from query results)",
      },
    },
    required: ["elementIds"],
  },
