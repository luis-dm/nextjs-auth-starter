export const skill = {
  ...
  description: "Select BIM elements in the 3D viewer by their IDs. Use this after querying elements to highlight them visually.",
  parameters: {
    type: "object",
    properties: {
      elementIds: {
        type: "array",
        items: { type: "number" },
        description: "Array of element IDs to select (localIds from query results)",
      },
    },
    required: ["elementIds"],
  },
